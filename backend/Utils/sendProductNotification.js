...
// //          </head>
// //           <!-- Outer wrapper - replace your existing <body> style -->
// // <body style="margin:0;padding:0;background: linear-gradient(135deg, #0f172a 0%, #1e3a5f 50%, #0f2d1a 100%);font-family:Arial,sans-serif;min-height:100vh;">
...
// //         <img src="${company.companyImage}" width="72"
// //           style="border-radius:14px;" alt="${company.companyName}" />
// //         <h1 style="color:#f8fafc;font-size:20px;font-weight:500;margin:10px 0 6px;">
// //           ${company.companyName}
// //         </h1>
