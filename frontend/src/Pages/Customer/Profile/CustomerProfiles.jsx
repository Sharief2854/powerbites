...
//             <Button variant="outlined" startIcon={<AddIcon />} onClick={() => navigate("/customer/editaddress")} sx={{ textTransform: 'none', borderRadius: 2 }}>
//               Add Address
//             </Button>
//           </Box>
...
//                     Delete
//                   </Button>
//                   <Button variant="contained" size="small" startIcon={<EditIcon />} onClick={() => navigate(`/customer/editaddress/${addr._id}`)} sx={{ textTransform: 'none', borderRadius: 2, bgcolor: "#673ab7", "&:hover": { bgcolor: "#5e35b1" } }}>
//                     Edit
//                   </Button>
//                 </Box>
//               </Paper>
...
//             <Button variant="outlined" color="inherit" startIcon={<ArrowBackIcon />} onClick={onBack || (() => navigate("/customer"))} sx={{ textTransform: 'none', borderRadius: 2 }}>
//               Back to Dashboard
//             </Button>
//           </Box>
//         </Paper>
